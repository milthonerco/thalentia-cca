...
import { inscribirEstudiante } from "../../lib/inscripciones";
...
export const POST: APIRoute = async ({ request }) => {
    try {
        ...
        await inscribirEstudiante(email, slug);
        ...
        const erroresEsperados = [
            ...
            "El tiempo límite de inscripción ha expirado" // <--- Añadido aquí
        ];

        if (erroresEsperados.includes(mensaje)) {
